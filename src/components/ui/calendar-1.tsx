"use client";
import { DatePicker, parseDate, type DateValue } from "@ark-ui/react/date-picker";
...
export default function BasicDatePicker({ value, onValueChange }: BasicDatePickerProps) {
  return (
    <DatePicker.Root
      inline
